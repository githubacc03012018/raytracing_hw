...
int main()
{
	...
	Triangle t0 = Triangle(Point3(-1.75, -1.75, -3), Point3(1.75, -1.75, -3), Point3(0, 1.75, -3));
	Triangle t1 = Triangle(Point3(0, 0, -1), Point3(1, 0, 1), Point3(-1, 0, 1));
	Triangle t2 = Triangle(Point3(0.56, 1.11, 1.23), Point3(0.44, -2.368, -0.54), Point3(-1.56, 0.15, -1.92));
